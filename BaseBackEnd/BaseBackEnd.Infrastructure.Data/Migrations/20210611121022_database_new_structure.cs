        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StayConnected = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "(CONVERT([bit],(0)))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdModule = table.Column<int>(type: "int", nullable: false),
                    IdPage = table.Column<int>(type: "int", nullable: false),
                    IdFunctionality = table.Column<int>(type: "int", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(GETDATE())"),
                    LastModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "(GETDATE())"),
                    IdCreationUser = table.Column<int>(type: "int", nullable: false),
                    IdLastModificationUser = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModulePageFunctionality", x => new { x.IdModule, x.IdPage, x.IdFunctionality })
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.IdModule, x.IdPage },
