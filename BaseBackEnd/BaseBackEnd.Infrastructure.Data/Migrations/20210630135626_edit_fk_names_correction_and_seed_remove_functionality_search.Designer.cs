...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseBackEnd.Domain.Entities.Security.UserProfile", b =>
                {
                    b.Property<int>("IdUser")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Status")
                        ...
                        .HasColumnType("int")
                        .HasDefaultValueSql("(CONVERT([bit],(1)))")
                        .HasComment("Status of UserProfile. Inactive = 0, Active=1, Blocked = 2, Deleted = 3");
            ...
            modelBuilder.Entity("BaseBackEnd.Security.Infrastructure.Data.EFCore.Context.DatabaseFunctions.DbFuncs", b =>
                {
            ...
            modelBuilder.Entity("BaseBackEnd.Domain.Entities.Security.UserProfile", b =>
                {
                    b.HasOne("BaseBackEnd.Domain.Entities.Security.User", "CreationUser")
                        .WithMany()
                        .HasForeignKey("IdCreationUser")
                        .HasConstraintName("FK_UserProfile_Creation_User")
                        .IsRequired();

                    b.HasOne("BaseBackEnd.Domain.Entities.Security.User", "LastModificationUser")
                        .WithMany()
                        .HasForeignKey("IdLastModificationUser")
                        .HasConstraintName("FK_UserProfile_Last_Modification_User");
