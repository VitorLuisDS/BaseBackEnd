...
namespace BaseBackEnd.Infrastructure.Data.Migrations
{
    ...
    [Migration("20210510185911_module_page_new_column_name")]
    partial class module_page_new_column_name
    {
            ...
            modelBuilder.Entity("BaseBackEnd.Domain.Entities.Security.Functionality", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("565356f7-4192-4ad9-93b2-7f59267eab30"),
                            Code = "approve",
                        ...
                        new
                        {
                            Id = new Guid("1a775433-5ebf-45b7-9c88-8c76306cf974"),
                            Code = "disapprove",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("41858062-f26d-4e4c-a043-c5f79088315a"),
                            Code = "activate",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("d0f1d0b4-29a2-4947-b659-5277392fe11d"),
                            Code = "inactivate",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("3b0ff8ed-552e-4382-9c84-8e25a5c23477"),
                            Code = "confirm",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("94c59cb1-90f4-42d9-9ddb-4da6f68b9150"),
                            Code = "cancel",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("db12ca96-f66e-4b87-afb3-c1450136fccb"),
                            Code = "search",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("0d2efc21-b550-4300-9f4b-a5f711025ead"),
                            Code = "export",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("bf3deaa1-daa0-481a-8bfc-038b5cdb85cb"),
                            Code = "add",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("f934ea9d-d333-433c-9697-b1ac08017ca6"),
                            Code = "update",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("2ec55a70-9a2c-4910-9848-903d19d33be9"),
                            Code = "remove",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("314b1eb3-c8db-4258-b9a2-8016d540a16e"),
                            Code = "consult",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("BaseBackEnd.Domain.Entities.Security.Module", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a8005864-8188-47cb-a256-f88ac42be388"),
                            Code = "security",
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
